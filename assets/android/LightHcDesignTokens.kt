...
object LightHcDesignTokens {
  ...
  val colorBgActionSecondaryHovered = Color(0x0f052657)
  val colorBgActionSecondaryPressed = Color(0x1f052e61)
  ...
  val colorIconPrimaryAlpha = Color(0xe6010309)
  val colorIconQuaternary = Color(0xff878f9b)
  val colorIconQuaternaryAlpha = Color(0x7a05152e)
  val colorIconSecondary = Color(0xff474a51)
  val colorIconSecondaryAlpha = Color(0xba030711)
  val colorIconSuccessPrimary = Color(0xff00553d)
  val colorIconTertiary = Color(0xff6c737e)
  val colorIconTertiaryAlpha = Color(0x94020e22)
...
letterSpacing = 0.em,
  ...
  val iconChat = R.drawable.ic_chat
  val iconCheck = R.drawable.ic_check
  val iconCheckCircle = R.drawable.ic_check_circle
  val iconChevron = R.drawable.ic_chevron
  val iconClose = R.drawable.ic_close
  val iconComputer = R.drawable.ic_computer
  val iconDelete = R.drawable.ic_delete
  val iconError = R.drawable.ic_error
  val iconInfo = R.drawable.ic_info
  val iconLock = R.drawable.ic_lock
  val iconMobile = R.drawable.ic_mobile
  val iconThread = R.drawable.ic_thread
  val iconUser = R.drawable.ic_user
  val iconVisibilityInvisible = R.drawable.ic_visibility_invisible
  val iconVisibilityVisible = R.drawable.ic_visibility_visible
  val iconWebBrowser = R.drawable.ic_web_browser
  val space0X = 0.dp
